...
const STATUSES = [
  ...
  { value: 'cold_email',   label: 'Cold Email',   dot: 'bg-pink-500'    },
...
export default function Dashboard() {
  ...
  const handleProfile  = () => navigate('/onboarding');
    ...
    >
      ...
      <header className="bg-white border-b border-gray-200 shadow-sm px-6 h-14 flex items-center justify-between sticky top-0 z-30">
        <div className="flex items-center gap-3">
          ...
          <span className="font-display italic text-lg font-bold text-gray-900">Trackfolio</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={handleProfile} title="Edit profile"
